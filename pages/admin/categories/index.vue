    ...
    <main class="c-main">
      <div class="container-fluid">
        <div class="fade-in">
          <div class="row">
            <div class="col-md-12">
              <div class="card border-0 rounded shadow-sm border-top-green">
                  ...
                  <div class="form-group">
                      <div class="input-group mb-3">
                          <div class="input-group-prepend">
                              <nuxt-link :to="{name: 'admin-categories-create'}" class="btn btn-ok btn-sm" style="padding-top: 10px;">
                          ...
                          <div class="input-group-append">
                              <button  @click="searchData" class="btn btn-ok"><i class="fa fa-search"></i>SEARCH</button>
                          </div>
                      </div>
                  </div>
