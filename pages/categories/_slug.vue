<template>
  ...
  export default {
      ...
      head() {
        return {
          title: `Category : ${this.category.name}  - Nizamstore - Toko Jual Beli Online Murah`,
          meta: [{
              hid: 'og:title',
              name: 'og:title',
              content: `Category : ${this.category.name}  - Nizamstore - Toko Jual Beli Online Murah`
            },
            {
              hid: 'og:site_name',
              name: 'og:site_name',
            ...
            },
            {
              hid: 'description',
              name: 'description',
              content: `Category : ${this.category.name}  - Official Toko Online Penjualan Produk murah`
            },
          ]
        }
      },
