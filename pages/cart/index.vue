<template>
  ...
  <script>
    export default {
      ...
      head() {
        return {
          title: 'Cart - Nizamstore - Toko Jual Beli Online Murah',
          meta: [{
              hid: 'og:title',
              name: 'og:title',
              content: 'Cart - Nizamstore - Toko Jual Beli Online Murah'
            },
            {
              hid: 'og:site_name',
              name: 'og:site_name',
            ...
            },
            {
              hid: 'description',
              name: 'description',
              content: 'Cart - Official Toko Online Penjualan Produk murah'
            },
          ]
        }
      },
